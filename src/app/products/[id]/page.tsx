...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  if (!product) {
    return { title: "Product Not Found | Merv IQF" };
  }

  const arabicNames: Record<string, string> = {
    strawberry: "فراولة مجمدة",
    mango: "مانجو مجمد",
    pomegranate: "رمان مجمد",
    "mixed-vegetables": "خضار مشكلة مجمدة",
    broccoli: "بروكلي مجمد",
    spinach: "سبانخ مجمد",
    "green-peas": "بسلة مجمدة",
    okra: "بامية مجمدة",
    molokhia: "ملوخية مجمدة",
    colocasia: "قلقاس مجمد",
    cauliflower: "قرنبيط مجمد",
    "broad-beans": "فول مجمد",
    "cut-green-beans": "فاصوليا خضراء مجمدة",
    "french-fries": "بطاطس مجمدة",
    artichokes: "خرشوف مجمد",
  };

  const arabicName = arabicNames[product.id] || product.name;

  return {
    title: `${product.name} | Merv IQF | ${arabicName} - Premium Frozen Export`,
    description: `Premium IQF frozen ${product.name} from Egypt. ${product.shortDescription} تصدير ${arabicName} مجمدة من مصر بجودة عالية.`,
    openGraph: {
      title: `${product.name} | Merv IQF Frozen Export`,
