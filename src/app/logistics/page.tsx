...
import { Globe2, Package, Database, MapPin, ShieldCheck, Anchor, Truck } from "lucide-react";
...
export const metadata: Metadata = {
  title: "Merv | Global Cold Chain Logistics | اللوجستيات وسلسلة التبريد",
  description: "Merv's global cold chain logistics network spanning 40+ ports, 15 hubs, and 3 continents. IoT-monitored, temperature-controlled frozen export from Egypt worldwide.",
  openGraph: {
    title: "Merv | Global Cold Chain Logistics Network",
    description: "15 hubs, 40+ ports, 3 continents. IoT-monitored cold chain logistics from Egypt.",
  },
};
