...
export const metadata: Metadata = {
  title: "Merv | About Us - Premium IQF Frozen Exports from Egypt | من نحن",
  description: "Learn about Merv, Egypt's leading exporter of IQF frozen fruits and vegetables. Ethical sourcing, Cryo-Fresh technology, global standards, and sustainable harvesting since MMXXVI.",
  openGraph: {
    title: "Merv | About Us - Premium IQF Frozen Exports from Egypt",
    description: "Discover Merv's story: ethical sourcing, Cryo-Fresh technology, and global standards in frozen export.",
    images: [{ url: "/assets/real_Image/sunrise_harvest.jpg", width: 800, height: 600, alt: "Merv Sunrise Harvest" }],
  },
};
